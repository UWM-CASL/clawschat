...
- The composer supports local attachments:
  ...
  - Every uploaded attachment is also written into the browser's Origin Private File System (OPFS) under a linux-style `/workspace/...` path for future workspace tools.
